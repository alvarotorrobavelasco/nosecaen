...
<div class="card shadow-sm">
    <div class="card-header bg-warning text-dark"><h5 class="mb-0">Editar Empleado</h5></div>
    <div class="card-body">
        <form action="{{ route('empleados.update', $empleado) }}" method="POST">
            ...
            <hr><p class="text-muted small">Dejar vacío para mantener contraseña actual</p>
            <div class="row">
                <div class="col-md-6 mb-3">
