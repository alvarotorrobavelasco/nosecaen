            ...
            <tbody>
                @forelse($incidencias as $inc)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('incidencias.show', $inc) }}" class="btn btn-sm btn-info text-white me-1" title="Ver">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('incidencias.edit', $inc) }}" class="btn btn-sm btn-warning me-1" title="Editar">
                                <i class="fas fa-edit"></i>
                            </a>

                            <!-- Eliminar SIN confirmación JS (Solo Admin) -->
                            @if(Auth::user()->tipo === 'administrador')
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center text-muted">No hay incidencias.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
